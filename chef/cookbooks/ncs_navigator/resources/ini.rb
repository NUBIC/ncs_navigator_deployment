...
attribute :cr_with_specimens, :kind_of => [TrueClass, FalseClass]
attribute :ops_bootstrap_user, :kind_of => String
attribute :ops_email_reminder, :kind_of => [TrueClass, FalseClass]
...
attribute :sc_recruitment_type_id, :kind_of => Integer
...
attribute :smtp_starttls, :kind_of => [TrueClass, FalseClass]
