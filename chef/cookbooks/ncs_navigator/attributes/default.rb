...
default[:ncs_navigator][:core][:worker][:concurrency] = 5
default[:ncs_navigator][:core][:scheduler][:pid] = "#{node[:ncs_navigator][:core][:shared_path]}/pids/scheduler.pid"
default[:ncs_navigator][:core][:scheduler][:log] = "#{node[:ncs_navigator][:core][:shared_path]}/log/scheduler.log"
